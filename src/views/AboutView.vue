...
const onSubmit = handleSubmit(async (values) => {
	...
	try {
		...
		// Handle any errors that occur during sign-in, e.g., display an error message.
		toast.add({
			severity: "error",
...
<template>
	<div class="flex min-h-screen">
		...
		<div class="w-full md:w-6 p-4 sm:p-4 md:p-8 flex align-items-center">
			<div class="w-full">
				<div class="mb-5">
					...
					<span class="font-normal" style="color: #808080"
						...
						<RouterLink
							to="/account/register"
							class="no-underline text-green-700"
						>
							Register Today!</RouterLink
						>
					</span>
				</div>
				<form @submit="onSubmit" class="flex flex-column gap-1">
					...
					<div
						class="flex align-items-center justify-content-between gap-5 mb-3"
					>
